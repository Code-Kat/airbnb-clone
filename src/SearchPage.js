...
function SearchPage() {
    return (
        <div className="searchPage">
            ...
            <div className="searchPage__mobileButton">
                  <Button variant="outlined">
                     Filters
                  </Button>
            </div>
                  ...
                  <SearchResult 
                     ...
                     title="屋上露天風呂★無料駐車場★JR難波駅徒歩7分★Free WIFI"
                     description="10 guests · 3 rooms · 5 beds · 1.5 bathrooms"
                     star={5}
                     price="$120/night"
                     total="$480"
                  /> 
                  ...
                  <SearchResult 
                     ...
                     title="#「泉-SEN」 PET可/USJ近/一軒家/プロジェクター/難波10分"
